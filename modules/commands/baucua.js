...
module.exports.config = {
  ...
  module.exports.run = async function({ api, event, args, Currencies, getText, permssion }) {
    try {
      ...
      // sendMessage
      api.sendMessage({
        body: '🌺𝑷𝒉𝒆́𝒑 𝑻𝒉𝒖𝒂̣̂𝒕 𝑾𝒊𝒏𝒙 𝑬𝒏𝑪𝒉𝒂𝒏𝑻𝒊𝒙...Đ𝒂𝒏𝒈 𝑳𝒂̆́𝒄\n🌺𝑪𝒉𝒖́𝒄 𝑩𝒂̣𝒏 𝑴𝒂𝒚 𝑴𝒂̆́𝒏...',
        ...
        setTimeout(() => {
          ...
          if (check >= 0 || check2 == true) {
            return api.sendMessage({
              body: `➢ 𝑳𝒂̆́𝒄 Đ𝒖̛𝒐̛̣𝒄: ${icon1} | ${icon2} | ${icon3}\n🌺𝘽𝙖̣𝙣 Đ𝙖̃ 𝙏𝙝𝙖̆́𝙣𝙜 𝙑𝙖̀ Đ𝙖̃ 𝙉𝙝𝙖̣̂𝙣 Đ𝙘 ${moneyBet * 3}$`,
              attachment: listimg
            }, threadID, () => Currencies.increaseMoney(senderID, moneyBet * 3), messageID);
          }
          else if (check < 0 || check2 == false) {
            return api.sendMessage({
              body: `➢ 𝑳𝒂̆́𝒄 Đ𝒖̛𝒐̛̣𝒄: ${icon1} | ${icon2} | ${icon3}\n🌺𝑩𝒂̣𝒏 Đ𝒂̃ 𝑻𝒉𝒖𝒂 𝑽𝒂̀ Đ𝒂̃ 𝑩𝒊̣ 𝑻𝒓𝒖̛̀ ${moneyBet}$`,
              attachment: listimg
