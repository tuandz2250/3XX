...
"https://i.imgur.com/YZ8cn2a.jpg",
     ...
     var callback = () => api.sendMessage({body:`Chảy nước miếng`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
