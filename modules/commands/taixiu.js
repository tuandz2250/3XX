...
module.exports.run = async function ({
    ...
    try {
        const res = await axios.get(`https://api.leanhtruong.net/v2/taixiu.php?api_key=LEANHTRUONG=dLuw13lBkdRmMuh3K4k09YaT7WoCD7ltJFpx8ICzX6r8apcbrH=APIKEY=PLANFREE&bet=t%C3%A0i`);
        var data = res.data;
